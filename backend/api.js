...
I need to know the estimated price of each ingredient in DKK - presume I'm buying them cheap. Lastly, set \`buy\` true if I need to buy it, false if I already have it in my fridge. Make the instructions short. Also write the name of the dish in danish with the first letter capitalized.
